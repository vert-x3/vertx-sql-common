...
public interface SqlConnection {
   ...
   */
  @Fluent
  SqlConnection query(String sql, JsonArray params, Handler<AsyncResult<ResultSet>> resultHandler);
   ...
   */
  @Fluent
  SqlConnection update(String sql, JsonArray params, Handler<AsyncResult<UpdateResult>> resultHandler);
