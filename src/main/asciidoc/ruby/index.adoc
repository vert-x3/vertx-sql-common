...
* `link:../../yardoc/VertxSql/SQLClient.html#query_stream-instance_method[queryStream]`
* `link:../../yardoc/VertxSql/SQLClient.html#query_stream_with_params-instance_method[queryStreamWithParams]`
