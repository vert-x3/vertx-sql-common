...
* Batched statements `link:../../jsdoc/sql_connection-SQLConnection.html#batch[batch]`
* Batched prepared statements `link:../../jsdoc/sql_connection-SQLConnection.html#batchWithParams[batchWithParams]`
* Batched callable statements `link:../../jsdoc/sql_connection-SQLConnection.html#batchCallableWithParams[batchCallableWithParams]`
