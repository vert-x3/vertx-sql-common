...
The handler will be called with the results, represented by `link:jsdoc/result_set-ResultSet.html[ResultSet]` when the query has
been run.
...
The `link:jsdoc/result_set-ResultSet.html[ResultSet]` instance represents the results of a query.

The list of column names are available with `link:jsdoc/result_set-ResultSet.html#getColumnNames[getColumnNames]`, and the actual results
available with `link:jsdoc/result_set-ResultSet.html#getResults[getResults]`
...
var columnNames = resultSet.getColumnNames();
...
You can also retrieve the rows as a list of Json object instances with `link:jsdoc/result_set-ResultSet.html#getRows[getRows]` -
this can give you a somewhat simpler API to work with, but please be aware that SQL results can contain duplicate
column names - if that's the case you should use `link:jsdoc/result_set-ResultSet.html#getResults[getResults]` instead.
...
The handler will be called with the results, represented by `link:jsdoc/update_result-UpdateResult.html[UpdateResult]` when the update has
been run.

The update result holds the number of rows updated with `link:jsdoc/update_result-UpdateResult.html#getUpdated[getUpdated]`, and
if the update generated keys, they are available with `link:jsdoc/update_result-UpdateResult.html#getKeys[getKeys]`.
...
connection.updateWithParams(update, params, function (res, res_err) {
  ...
  if (res_err == null) {
    ...
    console.log("No. of rows updated: " + updateResult.getUpdated());
